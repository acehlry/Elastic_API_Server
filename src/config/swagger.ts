      ...
      schemas: {
        MetricData: {
          ...
          properties: {
            ...
            os:         { type: 'string', example: 'Ubuntu', nullable: true },
            osVersion:  { type: 'string', example: '22.04.3 LTS', nullable: true },
            cpu:        { type: 'number', example: 45.2, nullable: true },
            memory:     { type: 'number', example: 67.8, nullable: true },
            ...
            load15:     { type: 'number', example: 0.9,  nullable: true },
            networkIn:  { type: 'number', example: 12.5, nullable: true, description: '수신 처리량 (KB/s)' },
            networkOut: { type: 'number', example: 5.3,  nullable: true, description: '송신 처리량 (KB/s)' },
          },
        },
        TimeSeriesData: {
          type: 'object',
          properties: {
            ...
            networkIn:  { type: 'number', example: 15.3, description: '수신 처리량 (KB/s)' },
            networkOut: { type: 'number', example: 8.1,  description: '송신 처리량 (KB/s)' },
          },
        },
        AnomalyData: {
          type: 'object',
          properties: {
            ...
            level:      { type: 'string', enum: ['ERROR', 'WARN', 'INFO'], example: 'WARN' },
            faultType:  { type: 'string', example: '02' },
            faultLevel: { type: 'string', example: '02' },
            remarks:    { type: 'string', example: 'CPU 사용률 75.0% 감지' },
            regDt:      { type: 'string', example: '2026-05-27T18:42:46.644+09:00' },
        ...
        ServerOverview: {
          ...
          properties: {
            ...
            os:         { type: 'string', example: 'Ubuntu', nullable: true },
            osVersion:  { type: 'string', example: '22.04.3 LTS', nullable: true },
            heartbeat:  { type: 'string', enum: ['alive', 'dead'], example: 'alive' },
            lastSeen:   { type: 'string', example: '2026-05-27T18:42:46.644+09:00' },
            cpu:        { type: 'number', example: 45.2, nullable: true },
            memory:     { type: 'number', example: 67.8, nullable: true },
            disk:       { type: 'number', example: 32.1, nullable: true },
            load1:      { type: 'number', example: 0.8,  nullable: true },
            load5:      { type: 'number', example: 1.2,  nullable: true },
            load15:     { type: 'number', example: 0.9,  nullable: true },
            networkIn:  { type: 'number', example: 1024.5, nullable: true },
            networkOut: { type: 'number', example: 512.3,  nullable: true },
          },
        },
        ServerTimeSeries: {
          type: 'object',
        ...
        HeartbeatEntry: {
          ...
          properties: {
            hostname: { type: 'string', example: 'web-server-01' },
            ip:       { type: 'string', example: '192.168.0.10' },
            status:   { type: 'string', enum: ['alive', 'dead'], example: 'alive' },
            lastSeen: { type: 'string', example: '2026-05-27T18:42:46.644+09:00' },
            cpu:      { type: 'number', example: 45.2, nullable: true },
            memory:   { type: 'number', example: 67.8, nullable: true },
            disk:     { type: 'number', example: 32.1, nullable: true },
        ...
        HeartbeatMonitor: {
          ...
          properties: {
            ...
            url:             { type: 'string', example: 'http://192.168.0.10:8080/health', nullable: true },
            ip:              { type: 'string', example: '192.168.0.10', nullable: true },
            port:            { type: 'integer', example: 8080, nullable: true },
            responseTimeMs:  { type: 'integer', example: 12, nullable: true },
            httpStatus:      { type: 'integer', example: 200, nullable: true },
            checkedAt:       { type: 'string', example: '2026-05-27T18:42:46.644+09:00' },
            availabilityPct: { type: 'integer', example: 99, nullable: true },
          },
        },
        LogEntry: {
          type: 'object',
        ...
        ApiError: {
          ...
          properties: {
            ...
            error:   { type: 'string', example: 'Server not found: 192.168.0.10' },
          },
        },
      },
      parameters: {
        timeRange: {
          ...
          name: 'timeRange',
          schema: { type: 'string' },
          description: 'Elasticsearch 날짜 수식 (예: now-15m, now-1h, now-24h)',
        },
        interval: {
          in: 'query',
          name: 'interval',
